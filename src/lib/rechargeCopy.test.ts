...
describe('formatRechargeCountdown', () => {
  ...
  it('충전이 임박했거나 이미 지난 경우 공통 문구를 쓴다', () => {
    expect(formatRechargeCountdown('2026-08-28T00:00:30.000Z', now)).toBe('곧 1장 충전');
    expect(formatRechargeCountdown('2026-08-27T23:59:00.000Z', now)).toBe('곧 1장 충전');
  });
