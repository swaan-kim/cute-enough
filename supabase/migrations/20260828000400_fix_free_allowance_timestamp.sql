-- Avoid the SQL CURRENT_TIME keyword shadowing the PL/pgSQL timestamp variable.
-- The keyword has type time with time zone, which cannot be written to timestamptz columns.
