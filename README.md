...
업로드한 강아지는 검수 전에도 업로더 본인의 집과 등록 완료 화면에 바로 나타나며, 그 강아지에 묶인 당일 보너스로 한 번 만날 수 있습니다. 보너스를 사용한 뒤에도 캐릭터는 집에 남습니다. 검수 중 공유 링크를 받은 사람에게는 캐릭터만 보이고 원본 사진은 노출되지 않습니다. 승인된 뒤에는 다른 사용자의 집 후보와 공유 링크에서 실제 사진을 만날 수 있습니다. `20260824000200_upload_rewards_and_sharing.sql` 이전의 기존 업로드에는 보상이 소급 적용되지 않습니다.
