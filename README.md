...
웹 데모는 설치 없이 드래그, 간식 주기, 쓰다듬기, 사진 공개와 업로드 흐름을 확인할 수 있습니다. 실제 토스 광고·사진 권한·사용자 식별키는 앱인토스 QR 테스트에서 별도로 확인해야 합니다.
...
- 자체 합성 효과음: 외부 음원 없이 강아지 선택·간식·쓰다듬기·사진 공개 소리를 실시간 생성
